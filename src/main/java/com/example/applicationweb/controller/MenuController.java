...
public class MenuController {
    ...
    @PostMapping(path = "/confirmation-order-file", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public String getOrderFile(Model model, HttpServletRequest request,
        ...
        String messenger = creatioOrderDaoService.createApplicationFile(order, client, filePhoto);
    ...
    @PostMapping("/confirmation-order-new")
    public ModelAndView getOrderNew(HttpServletRequest request) {
        ...
        result.addObject("reply", messenger);
